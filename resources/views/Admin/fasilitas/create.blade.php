...
@section('title', 'Tambah Fasilitas Baru - NginapKuy Admin')
                ...
                <form action="{{ route('admin.fasilitas.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="biaya_tambahan" name="biaya_tambahan" step="0.01" value="{{ old('biaya_tambahan') ?? 0 }}">
                        </div>
