...
@section('content')
    ...
    <div class="container my-5 grow">
        ...
        <div class="intro-card mb-5 text-center">
            <div class="card-body">
                {{-- PERBAIKAN: Menggunakan pengecekan Auth agar tidak error jika guest --}}
                <h2 class="card-title fs-2 mb-2">👋 Selamat Datang, {{ Auth::check() ? Auth::user()->name : 'Pengunjung' }}!</h2>
                                                ...
                                                @foreach ($kamar->tipeKamar->fasilitas as $fasilitas)
                                                    <li class="col-6">
                                                        <span class="fasilitas-icon">
                                                            ...
                                                            @elseif($fasilitas->nama_fasilitas == 'Balkon') 🏞️
                                                            @elseif($fasilitas->nama_fasilitas == 'Ruang Keluarga') 🛋️
                                                            @else ✨ @endif
                                                        </span>
