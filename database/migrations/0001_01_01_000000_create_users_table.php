...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_role')->nullable(); // Foreign key ke tabel roles
            $table->foreign('id_role')->references('id_role')->on('roles')->onDelete('set null');
        });

        // Tabel password_reset_tokens dan sessions
    ...
    {
        // >>> PASTIKAN DROP FOREIGN KEY INI ADA SAAT DOWN() <<<
